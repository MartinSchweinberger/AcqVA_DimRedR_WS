...
>
>This is essentially what PCA does. Principal components are variables that usefully explain variation in a data set - in this case, that usefully differentiate between groups. Each principal component is one of your original explanatory variables, or a combination of some of your original explanatory variables." (Freya Harrison)
>


Let's delve into an easy example to get a better understanding of the theoretical underpinnings of PCA and to see how it works (this section is based on Starmer (2018)) (a very brief, nice, and easy to understand explanation of PCA is available [here](https://stats.stackexchange.com/questions/2691/making-sense-of-principal-component-analysis-eigenvectors-eigenvalues/2700#2700) Amoeba (2022))... 
...
pcadat <- scale(as.matrix(pcadat[,2:3])) %>% as.data.frame()
```



![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p01.png?raw=true)

To understand how PCA works, let us start by plotting the first feature (Feat1).

![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p02.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p03.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p04.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p05.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p06.png?raw=true)

We start by calculating the center of the data.

![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p07.png?raw=true)

Next we scale and center the data so that the center is at (0,0).


![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p08.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p10.png?raw=true)
</p>
<p style='margin-left:1em;'>
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p11.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p12.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p13.png?raw=true)


PC2 is simply the perpendicular line to PC1 that goes through 0,0.

![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p14.png?raw=true)

As PC1 and PC2 are perpendicular, the Eigenvector of PC2 is -0.685 of Feat1 and 0.728 of Feat2.


![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p15.png?raw=true)

We can (but have to) rotate the PC1 and make the points smaller (so that our plot looks more like a proper PCA plot).

![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p16.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p17.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p18.png?raw=true)
...
![](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS/blob/main/images/p19.png?raw=true)
...
As a first step, we generate a scree plot to assess how many factors are in our data. There are two ways to interpret the output: (a) we choose the number of factors where there is a noticeable bend in the eigenvalues of the factors or, if there is no noticeable bend (the so-called *point of inflexion* (Field, Miles, and Field 2012, 763), (b) select the last value above 1 (following Kaiser (1960) - however, Jolliffe (1987) suggests using .7 as 1 is too strict) (see Field, Miles, and Field 2012, 763 for more details on this discussion).
...
Schweinberger, Martin. 2023. *Introduction to Dimension Reduction Methods with R - AcqVA Aurora workshop*. Tromsø: The Arctic University of Norway, Tromsø. url: https://slcladal.github.io/introviz.html  (Version 2023.08.25).



## References

Amoeba. 2022. *Making Sense of Principal Component Analysis, Eigenvectors and Eigenvalues.*”* Cross Validated. https://stats.stackexchange.com/q/140579.  
...
Jacoby, William G, and David J Ciuk. 2018. Multidimensional Scaling: An Introduction. In *The Wiley Handbook of Psychometric Testing: A Multidisciplinary Reference on Survey, Scale and Test Development*, 375–412.  
...
Kim, Jae-On, and Charles W Mueller. 1978. *Introduction to Factor Analysis: What It Is and How to Do It*. Sage.
